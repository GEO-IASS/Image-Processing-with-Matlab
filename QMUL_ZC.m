function [ im , image ] = QMUL_ZC( imagename , filetype , kernel , sd , filter )
%% LoG
...
% To use type:
% [ im , image ] = QMUL_ZC('Images/Lena512_Binary.pgm','pgm',3,2,'Laplacian1');
% [ im , image ] = QMUL_ZC('Images/Lena512C_Binary.ppm','ppm',3,2,'Laplacian1');
...
figure
BW = edge(image,'zerocross',0.0001,'LoG');
imshow(BW)
